...
out.print("request.getCharacterEncoding()  : " + request.getCharacterEncoding() + "<br/>");
out.print("request.getContentLength()      : " + request.getContentLength() + "<br/>");
out.print("request.getContentType()        : " + request.getContentType() + "<br/>");
out.print("request.getLocalAddr()          : " + request.getLocalAddr() + "<br/>");
out.print("request.getLocalName()          : " + request.getLocalName() + "<br/>");
out.print("request.getLocalPort()          : " + request.getLocalPort() + "<br/>");
...
out.print("request.getRemoteHost()         : " + request.getRemoteHost() + "<br/>");
out.print("request.getRemotePort()         : " + request.getRemotePort() + "<br/>");
out.print("request.getRemoteUser()         : " + request.getRemoteUser() + "<br/>");
out.print("request.getRequestedSessionId() : " + request.getRequestedSessionId() + "<br/>");
